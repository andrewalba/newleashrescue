...
<template>
  <div>
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
      ...
      <UButton :icon="IconPayPal" class="py-2 px-3 inline-flex items-center gap-x-2 text-lg font-medium text-nowrap rounded-xl text-white bg-primary border border-primary-line hover:bg-primary-hover focus:outline-hidden focus:bg-primary-focus transition disabled:opacity-50 disabled:pointer-events-none"  name="submit" title="PayPal - The safer, easier way to pay online!">
         Paypal Donate
      </UButton>
